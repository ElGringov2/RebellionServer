...
class Planet
{
    ...
    static function CreateGalaxy()
    {
        ...
        $galaxy = [
            ...
            (object)["name" => "DQar", "X" => "-3043", "Y" => "2004"],
            (object)["name" => "Endor", "X" => "-2598", "Y" => "-2601"],
            (object)["name" => "Felucia", "X" => "2345", "Y" => "4431"],
            (object)["name" => "Geonosis", "X" => "-2523", "Y" => "4401"],
            (object)["name" => "Hosnian Prime", "X" => "-629", "Y" => "-117"],
            (object)["name" => "Hoth", "X" => "-3446", "Y" => "-887"],
            (object)["name" => "Ithor", "X" => "2335", "Y" => "-99"],
            ...
            (object)["name" => "Nar Shadda", "X" => "-411", "Y" => "4846"],
            (object)["name" => "Onderon", "X" => "710", "Y" => "2287"],
            (object)["name" => "Ord Mantell", "X" => "2245", "Y" => "-630"],
            (object)["name" => "Rattatak", "X" => "-2258", "Y" => "-2809"],
